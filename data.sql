...
INSERT INTO
    Searchs (searchId, username, content)
VALUES (
        UNHEX(
            REPLACE (UUID(), '-', '')
        ),
        'user1',
        'Looking for a room in the city center.'
    ),
    (
        UNHEX(
            REPLACE (UUID(), '-', '')
        ...
        'user2',
        'Searching for pet-friendly accommodations.'
    ),
    (
        UNHEX(
            REPLACE (UUID(), '-', '')
        ...
        'tenant1',
        'Need a room with kitchen facilities.'
    ),
    (
        UNHEX(
            REPLACE (UUID(), '-', '')
...
INSERT INTO
    MotelRules (motelRuleId, motelId, ruleId)
VALUES (
        UNHEX(
            REPLACE (UUID(), '-', '')
        ),
...
VALUES (
        ...
        (
            SELECT nameMotelServicesId
            FROM NameMotelServices
            WHERE
                nameService = 'Room Cleaning'
        )
    ),
    (
        UNHEX(
    ...
    (
        ...
        (
            ...
            FROM NameMotelServices
            WHERE
                nameService = 'High-Speed Internet'
        )
    ),
    (
        UNHEX(
...
VALUES (
        ...
        'tenant1',
        'Room Available',
        'Your requested room is now available.',
        1
    ),
    (
        UNHEX(
    ...
    (
        ...
        'user2',
        'Lease Ending',
        'Your lease is ending next week.',
        1
    ),
    (
        UNHEX(
        ...
        'tenant1',
        'New Amenities',
        'We have added new amenities to your building.',
        1
    ),
    (
        UNHEX(
...
VALUES (
        ...
        'landlord1',
        'Room for Rent',
        'Room available starting next month.',
        '2024-10-01'
    ),
    (
        UNHEX(
    ...
    (
        ...
        'user2',
        'Available for Rent',
        'Room available for immediate rent.',
        '2024-09-10'
    ),
    (
        UNHEX(
    ...
    (
        ...
        'tenant1',
        'Seeking Tenants',
        'Looking for tenants for a lovely room.',
        '2024-09-25'
    );
...
SELECT CONCAT(
        SUBSTRING(HEX(roleId), 1, 8), '-', SUBSTRING(HEX(roleId), 9, 4), '-', SUBSTRING(HEX(roleId), 13, 4), '-', SUBSTRING(HEX(roleId), 17, 4), '-', SUBSTRING(HEX(roleId), 21)
    ) AS uuid, roleName
FROM roles;
...
VALUES (
        'd2a4bc8d-b9cb-46e7-911e-3f5123121d47',
        '1cd05875-80b0-11ef-afb2-00155d90dfbc',
        'c2a4bc8d-b9cb-46e7-911e-3f5123121d34',
        'Phòng A101',
        5000000.00,
        20.50,
        true,
        'Phòng rộng rãi, thoáng mát, có cửa sổ lớn và ban công.'
    ),
    (
        'e3b5cd9e-c7de-46e7-922e-4g6234232e58',
        '1cd05875-80b0-11ef-afb2-00155d90dfbc',
        'c2a4bc8d-b9cb-46e7-911e-3f5123121d34',
        'Phòng B102',
        4500000.00,
        18.00,
        false,
        'Phòng có trang bị đầy đủ nội thất, thích hợp cho 1-2 người.'
    ),
    (
        'f4c6deaf-d8ef-46e7-933f-5h7345343f69',
        '1cd05875-80b0-11ef-afb2-00155d90dfbc',
        'd3b5ef9e-c7de-46e7-922e-4g6234232e67',
        'Phòng C201',
        7000000.00,
        25.00,
        true,
        'Phòng mới xây, sàn gỗ, có máy lạnh và giường ngủ.'
    ),
    (
        'a1b3cd8d-b9cb-46e7-911e-1f5123121e45',
        '1cd05875-80b0-11ef-afb2-00155d90dfbc',
        'd3b5ef9e-c7de-46e7-922e-4g6234232e67',
        'Phòng D203',
        6000000.00,
        22.00,
        false,
        'Phòng có tủ quần áo và kệ bếp, phù hợp cho gia đình nhỏ.'
    ),
    (
        'b2d4ef9e-c7de-46e7-922e-2h7456454g34',
        '1cd05875-80b0-11ef-afb2-00155d90dfbc',
        'e4f6gh9e-c7de-46e7-922e-4g6234232e55',
        'Phòng E303',
        8000000.00,
        28.00,
        true,
        'Phòng diện tích rộng, có phòng tắm riêng và wifi tốc độ cao.'
    );
