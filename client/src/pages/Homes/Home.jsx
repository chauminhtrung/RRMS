            ...
            <Grid item xs={6} sm={6} md={4} lg={2}>   
                <Box className="custom-box">  
                    <Box display="flex" alignItems="center">  
                        ...
                        <svg className="svg-icon" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: '8px' }}>  
          ...
          <Grid container spacing={2} mt={4}>  
            {features1.map((feature, index) => (  
              <Grid item xs={12} md={4} key={index} data-aos-disable="zoom-in-up">  
                <Box className="inner">  
                  <Box className="image">  
                    <img src={feature.img} width="383" height="282" className="img-fluid" title={feature.title} alt={feature.title} />  
                  </Box>  
                  <Box textAlign="center" mt={3} mb={2}>  
                    <Button variant="contained" className={`btn btn-platform ${index === 0 ? 'mobile' : index === 1 ? 'ipad' : 'desktop'}`} href={feature.link}>  
                      {feature.buttonLabel}  
                    </Button>  
                  </Box>  
                ...
                <div className="item-inner inner-testimonial">  
                    <article className="text-center">  
                        ...
                        <Typography className="section-description">  
                            Sự hài lòng của khách hàng là động lực giúp chúng tôi hoàn thiện ứng dụng,  
                            đồng thời mở ra cơ hội có thêm nhiều khách hàng mới trong tương lai.<br/>  
                            Chúng tôi chân thành cảm ơn khách hàng đã tin dùng cũng như đóng góp giúp phần mềm ngày càng hoàn thiện hơn!  
                        </Typography>  
                    </article>  
                                    ...
                                    <div className="d-flex align-items-center" >  
                                        ...
                                        <div className="col-inner">  
                                            <Typography className="conut-num">  
                                                <span className="count-up active">{stat.count}</span><sup>+</sup>  
                                            </Typography>  
                            ...
                            <Grid item sm={12} md={6} >  
                                <article className="card-feature" >  
                                    ...
                                    <Typography paragraph style={{ textAlign: 'justify' }}>  
                                        ...
                                        Nhận thấy được vấn đề đó, đội ngũ <b>RRMS - Quản lý trọ</b> chúng tôi được ra đời nhằm chia sẻ phần
                                        <b> RRMS - Quản lý trọ</b> chúng tôi được ra đời nhằm chia sẻ phần nào những khó khăn của các chủ nhà trọ đang gặp phải.  
                                    </Typography>  
                                </article>  
                            </Grid>  
                            <Grid item sm={12} md={6}>  
                                <article className="card-feature">  
                                    ...
                                    <Typography paragraph style={{ textAlign: 'justify' }}>  
                                        ...
                                        Chúng tôi luôn coi sự hài lòng của khách hàng là thành công và đặt lợi ích khách hàng lên hàng đầu.   
...
const features = [  
  ...
  const features1 = [  
    {  
      ...
      description: 'Quản lý ngay trên chiếc điện thoại. Nhẹ nhàng, thuận tiện, linh hoạt với đầy đủ tính năng và được đồng bộ với các nền tảng khác.'
    },  
    {  
      ...
      description: 'Nếu bạn đang có chiếc máy tính bảng là một lợi thế. Bạn có thể kết hợp được sự linh hoạt giữa điện thoại và máy tính.'
    },  
    {  
      ...
      description: 'Quản lý ngay trên website mà không cần cài đặt app. Tất cả các tính năng sẽ rất chi tiết, sẽ giúp bạn quản lý thuận tiện đầy đủ.'
    }  
  ];  
...
const testimonials = [  
    ...
    {  
        ...
        rooms: "8 phòng",  
        role: "Chủ nhà",  
        feedback: "Tôi rất thích ứng dụng vì rất tiện lợi, phòng của tôi không nhiều nhưng trước khi biết đến ứng dụng tôi phải quản lý sổ sách rất cực. Giờ thì khoẻ hơn nhiều. Cảm ơn LOZIDO!",  
    ...
    {  
        ...
        rooms: "30 phòng",  
        role: "Chủ nhà",  
        feedback: "Phòng trọ của mình tương đối nhiều. Trước đây mình thường rất mất nhiều thời gian trong công việc quản lý. Mình tốn thời gian ghi nhớ, tính toán sổ sách hàng tháng. Từ khi được bạn giới thiệu ứng dụng mọi việc tốt hơn.",  
    ...
    {  
        ...
        rooms: "20 phòng",  
        role: "Chủ nhà",  
        feedback: "Tôi có nhiều thời gian cho bản thân hơn từ khi biết đến ứng dụng quản lý nhà trọ của LOZIDO. Thật sự cảm ơn các bạn đã giới thiệu và hỗ trợ tôi!",  
