                ...
                <div id="content">
                    <div className="row">
                        <div className="col-sm-12 col-md-3 col-lg-3 mt-2">
                            <div className="iContact inner-item text-center">
                                <a rel="nofollow, noindex" href="https://www.facebook.com/profile.php?id=61562538557177">
                                    <div className="iconContact"><img src="https://lozido.com/images/banner/fanpage.webp" style={{ width: '90px' }} alt="icon fanpage facebook" />
                        ...
                        <div className="col-sm-12 col-md-3 col-lg-3 mt-2">
                            <div className="iContact inner-item text-center">
                                <a rel="nofollow, noindex" href="https://www.facebook.com/profile.php?id=61562538557177">
                                    <div className="iconContact"><img src="https://lozido.com/images/banner/messager.webp" style={{ width: '90px' }} alt="ion messager" />
                        ...
                        <div className="col-sm-12 col-md-3 col-lg-3 mt-2">
                            <div className="iContact inner-item text-center">
                                <a rel="nofollow, noindex" href="tel:0373395604">
                                    <div className="iconContact"><img src="https://lozido.com/images/banner/phone.webp" style={{ width: '90px' }} alt="icon phone" />
                        ...
                        <div className="col-sm-12 col-md-3 col-lg-3 mt-2">
                            <div className="iContact inner-item text-center">
                                <a rel="nofollow, noindex" href="mailto:nguyentantai0118@gmail.com?Subject=Liên%20hệ%20RRSM.com" target="_top">
                                    <div className="iconContact"><img src="https://lozido.com/images/banner/email.webp" style={{ width: '90px' }} alt="icon email" />
