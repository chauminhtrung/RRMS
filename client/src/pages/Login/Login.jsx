        ...
        <div className="login-container d-flex" id="login">
          <div className="login-content-container">
            ...
            <div className="row login-form-container">
              ...
              >
                ...
                >
                  <input
                    type="hidden"
                    name="_token"
                    value="jkJEHM7McmP1rRwYRqXYkCRrsj0oZZEtjCSD9vlp"
                  />{" "}
                  ...
                  <div class="mt-2 text-center">
                    ...
                    <a
                      href="#"
                      class="btn-social btn-social-outline btn-googleplus"
                    >
                      <GoogleIcon />
                    </a>
                    <a
              ...
              <div
                className="col-md-6 login-form-2 text-center"
                style={{ color: "#fff" }}
              >
                <div className="mt-5">
                  <img
                  ...
                  <div class="row mt-2 g-2">
                    <div
                      class="col-sm-12 col-md-6 text-center text-md-end aos-init aos-animate"
                      data-aos="fade-right"
                    >
                      <a
                        href="https://play.google.com/store/apps/details?id=com.lozido_room_mobile"
                        target="_blank"
                      >
                        <img
                          class="img-responsive image-dowload-app"
                          width="160px"
                    ...
                    <div
                      class="col-sm-12 col-md-6 text-center text-md-start aos-init aos-animate"
                      data-aos="fade-left"
                    >
                      <a
                        href="https://apps.apple.com/vn/app/id1560928216"
                        target="_blank"
                      >
                        <img
                          class="img-responsive image-dowload-app"
                    ...
                    <p
                      ...
                      class="text-center"
                    >
                      * Để đăng nhập bạn phải có tài khoản. Vui lòng đăng ký tài
                      khoản nếu chưa có
                    </p>
                  </div>
                </div>
