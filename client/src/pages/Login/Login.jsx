              ...
              <div className="col-md-6 login-form-2 text-center" style={{ color: '#fff' }}>  
                <div className="mt-5">  
                  ...
                  <div className="row mt-2 g-2">  
                    <div className="col-sm-12 col-md-6 text-center text-md-end aos-init aos-animate" data-aos="fade-right"></div>  
                    <div className="col-sm-12 col-md-6 text-center text-md-start aos-init aos-animate" data-aos="fade-left"></div>  
                  </div>  
