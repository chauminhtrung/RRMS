                        ...
                        <div className="row mt-3">
                            <div className="col-md-8">
                                <p style={{ marginTop: '0px' }}>
                                    Tìm nhà trọ có lẽ không còn là câu chuyện xa lạ đối với những người học tập và làm việc xa nhà.
                                    Đã từng trải qua những khó khăn trong quá trình đi <b>tìm phòng trọ</b>,
                                    chúng tôi thấu hiểu phần nào nỗi phiền muộn ấy, như phải chạy xe giữa cái nắng của thành phố
                                    để tìm được căn trọ như ý hay thậm chí là ở trong những căn trọ ẩm thấp, kém chất lượng…
                                    Hiểu được nỗi lo ấy,<b> RRMS - Tìm trọ, căn hộ, việc làm</b> đã ứng dụng công nghệ vào thực tiễn,
                                    giúp mọi người dễ dàng hơn trong việc đi <b>tìm phòng trọ</b>, đồng thời giúp người cho thuê phòng
                                    trọ tìm kiếm được “khách hàng” của mình.
                                </p>
                                <p>
                                    <b>RRMS - Tìm trọ, căn hộ, việc làm</b> cung cấp ứng dụng đáp ứng nhu cầu tìm nhà trọ dễ dàng,
                                    nhanh chóng với nhiều danh mục đa dạng, gần gũi như: <b>tìm phòng trọ</b> giá rẻ,
                                    phòng trọ gần khu công nghiệp, trường học, công ty...
                                </p>
                            </div>
                            <figure className="col-md-4 text-center image-right" style={{ margin: '0px' }}>
                                <img style={{ borderRadius: '10px' }}
                                    ...
                                    width="90%" alt="Sinh viên tìm phòng trọ" />
                                <div>Tìm trọ với ứng dụng <b>RRMS - Tìm trọ, căn hộ, việc làm</b></div>
                            </figure>
                        </div>
                    </section>
                            ...
                            <div className="wrap-gallery-infor row">
                                <div className="row mt-4">
                                    <div className="col-md-6 col-md-push-6 col-sm-12 col-sm-push-6 col-xs-12" style={{ textAlign: 'right' }}>
                                        ...
                                        <p>
                                            Tạo một môi trường thuê và cho thuê nhà trọ minh bạch, rõ ràng, đem lại niềm tin
                                            và cái nhìn lạc quan hơn trong cuộc sống trọ.
                                        </p>
                    ...
                    <section className="text-center" style={{ marginTop: '50px' }}>
                        ...
                        <div className="row mt-4">
                            ...
                            <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 " style={{ textAlign: 'left' }}>
                                ...
                                <p><img src="https://lozido.com/images/icons/check.svg" /> Luôn hướng đến sự minh bạch - rõ ràng - trung thực</p>
                                <p><img src="https://lozido.com/images/icons/check.svg" /> Với tinh thần thép luôn luôn học hỏi và lắng nghe, sản phẩm được cải tiến - nâng cấp không ngừng để đáp ứng hầu hết các nhu cầu của thị trường.</p>
                                <p><img src="https://lozido.com/images/icons/check.svg" /> Với thế mạnh về công nghệ, đội ngũ LOZIDO đã ứng dụng vào thực tiễn giúp cho việc kết nối giữa người cho thuê và khách thuê dễ dàng. Tiết kiệm thời gian, chi phí.</p>
                            </div>
                        </div>
                    </section>
                        ...
                        <section className="col-md-12">
                            ...
                            <div className="item-container aos-init" data-aos="fade-right">
                                <div className="item-content d-flex flex-row mt-2" style={{ display: 'flex' }}>
                                    ...
                                    <div className="item-ft-text flex-grow-1">
                                        Quy trình làm việc chặt chẽ và được chuẩn hóa.
                                    </div>
                                </div>
                            </div>
