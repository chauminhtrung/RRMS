              ...
              <div className="col-12 p-4">
                <div className="body">
                  <div className="mt-5">
                    <form
                      method="POST"
                      className="needs-validation otp-form"
                      id="otp-form"
                      novalidate=""
                    >
                      <input
                      ...
                      <div style={{ marginTop: "20px" }}>
                        <p>
                          Chúng tôi sẽ gữi một mã xác nhận về tài khoản Zalo qua
                          số điện thoại bạn nhập. Để xác minh tính hợp lệ trước
                          khi yêu cầu đổi mật khẩu
                        </p>
                      </div>
