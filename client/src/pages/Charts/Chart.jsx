      ...
      <Container>
        ...
        <Box className="wrapper-banner">
          <Box className="container-banner">
            <Box className="about">
              <AboutItem iconClass="bi bi-graph-up-arrow" text="Giá thực tế đang giao dịch trên thị trường" />
              <AboutItem iconClass="bi bi-geo-alt" text="Chi tiết đến từng phường / huyện 5 thành phố lớn" />
              <AboutItem iconClass="bi bi-building" text="Phân loại riêng biệt nhà đất, chung cư" />
            </Box>
          </Box>
        </Box>

        <Box sx={{ flexGrow: 1 }}>
          <Typography className="align-content-center text-center mt-5" variant="h3">
            Xem giá nhà trọ
          </Typography>
          <Typography className="align-content-center text-center mt-1 mb-3">
            Chọn khu vực và loại bất động sản mà bạn muốn xem giá
          </Typography>
          <Grid container spacing={2}>
            <Grid item xs={6} sm={6} md={6} lg={3}>
              <FormControl fullWidth>
                <InputLabel id="property-type-label">Chọn loại hình (Nhà ở, Căn hộ...)</InputLabel>
                <Select labelId="property-type-label" defaultValue="" className="select">
                  <MenuItem value="" disabled>
                    Chọn loại hình (Nhà ở, Căn hộ...)
                  </MenuItem>
            ...
            <Grid item xs={6} sm={6} md={6} lg={3}>
              <FormControl fullWidth>
                ...
                <Select labelId="area-label" defaultValue="" className="select">
                  <MenuItem value="" disabled>
                    Chọn khu vực (Tỉnh/thành, quận...)
                  </MenuItem>
            ...
            <Grid item xs={6} sm={6} md={6} lg={3}>
              <TextField variant="outlined" className="select" placeholder="Nhập tên đường bạn muốn" fullWidth />
            </Grid>
            <Grid item xs={6} sm={6} md={6} lg={3}>
              <Button sx={{ padding: '15px 87px' }} variant="contained">
                Xem giá ngay
              </Button>
            </Grid>
          </Grid>
            ...
            <Grid item xs={6} sm={6} md={6} lg={4}>
              <Box className="cardWrapper" flex="1" m={1}>
                ...
                <Box className="LoadDetail__Wrapper">
                  <Button variant="outlined" className="buttonDetail">
                    Xem chi tiết
