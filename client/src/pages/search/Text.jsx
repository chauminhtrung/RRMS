  ...
  return (
    <Box>
      ...
      <Typography variant="h5" sx={{ mt: 3 }}>
        ...
        {} cũng trải dài theo các vị trí này. Trong đó, phòng trọ gần trường,
      ...
      <Typography variant="h5" sx={{ mt: 3 }}>
        ...
        {} rất đa dạng, thuộc nhiều độ tuổi và ngành nghề khác nhau. Từ đó, đặt
      ...
      <Typography variant="h5" sx={{ mt: 3 }}>
        ...
        {} gồm nhiều phân khúc từ phòng trọ giá rẻ, phòng trọ bình dân, ký túc
        xá sinh viên cho đến chung cư, căn hộ cao cấp. Tùy thuộc vào diện tích,
      ...
      <Typography variant="h5" sx={{ mt: 3 }}>
        ...
        {} tại các quận trung tâm như quận 1, quận 3, quận 5 thường có giá dao
        động từ 3.000.000 - 7.000.000 đồng/tháng. Phòng trọ tại các quận kế
      ...
      <Typography variant="h5" sx={{ mt: 3 }}>
        ...
        nước như phòng trọ Hà Nội,{" "}
        <Typography variant="span" sx={{ color: "blue" }}>
          {} phòng trọ Đà Nẵng, phòng trọ Cần Thơ
        </Typography>
        ,... Bên cạnh đó, các khu vực nhà trọ cũng sẽ được “chia nhỏ” theo quận,
        huyện hay theo từng khu vực đặc biệt để người dùng có thể thuận tiện tìm
        kiếm. DQ4T sẽ đồng hành để mang đến cho bạn căn trọ hài lòng nhất.
      </Typography>
    </Box>
  );
};
