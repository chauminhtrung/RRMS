        ...
        {showMore && (
          <>
            <Typography variant="h6" sx={{ mt: 3 }}>
              ...
              được một căn trọ như ý là điều không dễ dàng. Hiểu được nỗi lòng đó, LOZIDO mang đến cho bạn giải pháp tìm
            ...
            <Typography variant="h6" sx={{ mt: 3 }}>
              ...
              {} cũng trải dài theo các vị trí này. Trong đó, phòng trọ gần trường, gần KCN, gần chợ, gần siêu thị là
              những vị trí “đắc địa”, nhận được nhiều sự quan tâm của khách thuê.
            </Typography>
            <Typography variant="h6" sx={{ mt: 3 }}>
            ...
            <Typography variant="h6" sx={{ mt: 3 }}>
              ...
              {} gồm nhiều phân khúc từ phòng trọ giá rẻ, phòng trọ bình dân, ký túc xá sinh viên cho đến chung cư, căn
              hộ cao cấp. Tùy thuộc vào diện tích, vị trí, cơ sở vật chất mà mức giá cho thuê cũng có sự chênh lệch đáng
              kể.
            </Typography>
            <Typography variant="h6" sx={{ mt: 3 }}>
              Cụ thể, dịch vụ {}
              ...
              {} tại các quận trung tâm như quận 1, quận 3, quận 5 thường có giá dao động từ 3.000.000 - 7.000.000
              đồng/tháng. Phòng trọ tại các quận kế trung tâm như Bình Thạnh, Phú Nhuận, Tân Bình sẽ dao động từ
              2.000.000 - 5.000.000 đồng/tháng.
            </Typography>
            <Typography variant="h6" sx={{ mt: 3 }}>
              Các khu vực càng xa trung tâm thành phố hoặc xa các khu vực trường Đại học, khu công nghiệp thì phân khúc
              giá {}
              <Typography variant="span" sx={{ fontWeight: 'bold', mt: 3 }}>
                cho thuê phòng trọ TPHCM
              </Typography>
            ...
            <Typography variant="h6" sx={{ mt: 3 }}>
              ...
              ,... Bên cạnh đó, các khu vực nhà trọ cũng sẽ được “chia nhỏ” theo quận, huyện hay theo từng khu vực đặc
              biệt để người dùng có thể thuận tiện tìm kiếm. DQ4T sẽ đồng hành để mang đến cho bạn căn trọ hài lòng
              nhất.
            </Typography>
          </>
        )}
