    ...
    <>
      <div className="container" style={{ marginBottom: '30px' }}>
        ...
        {bulletinBoards.map((board) => (
          ...
          <div key={board.id} className="hehe">
            <hr />
            <div className="container mt-4">
              <div className="row">
                <div className="col-lg-4">
                  <Slider {...settings}>
                    {board.bulletinBoardImages.map((slide) => (
                      <div key={slide.bulletinBoardImageId}>
                        <img
                          src={slide.imageLink}
                          alt={`Slide ${slide.id}`}
                ...
                <div className="col-lg-4 text-center">
                  <Typography sx={{ fontSize: '20px' }}>{board.title}</Typography>
                  <Typography sx={{ fontSize: '13px' }}>
                    {board.address || 'Địa chỉ chưa cập nhật'}
                  </Typography>
                  <div>
                    Giá: <b className="text-danger">
                      <span style={{ textDecoration: 'line-through', fontSize: '13px' }}>{formatCurrency(board.rentPrice)}  </span>
                      <span>{formatCurrency(board.promotionalRentalPrice)}  </span></b>
                  </div>
                  <div className="row" style={{ textAlign: 'left' }}>
                    <div className="col-6">
                      ...
                      <Typography sx={{ fontSize: '13px' }}>
                        ...
                        Tình trạng: {board.rentalCategory}
                      </Typography>
                      <Typography sx={{ fontSize: '13px' }}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        Giờ giấc: {board.openingHours} - {board.closeHours}
                      </Typography>
                    </div>
                    <div className="col-6">
                      <Typography sx={{ fontSize: '13px' }}>
                      ...
                      <Typography sx={{ fontSize: '13px' }}>
                        ...
                        Số lượng người: {board.maxPerson}
                      </Typography>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 text-center mt-2">
                  <img
                    ...
                    src={board.account.avatar}
                    alt=""
                    srcset=""
                  />
                  <Typography sx={{ fontSize: '13px' }}>Chủ trọ: {board.account.username}</Typography>
                  <button className="btn btn-success mt-2" style={{ width: '100px' }} onClick={() => handleApprove(board.bulletinBoardId)}>
                    Xét duyệt
                  </button>{' '}
                  <br />
                  <button className="btn btn-danger mt-2" style={{ width: '100px' }} onClick={() => handleDelete(board.bulletinBoardId)}>
                    Hủy
                  </button>
                </div>
              </div>
