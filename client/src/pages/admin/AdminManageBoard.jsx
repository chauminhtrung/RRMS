                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <Slider {...settings}>
                                {slides.map((slide) => (
                                    <div key={slide.id}>
                                        <img src={slide.src} alt={`Slide ${slide.id}`} style={{ width: '100%', maxHeight: '200px', objectFit: 'cover' }} />
                                    </div>
                                ))}
                            </Slider>
                        </div>
                        <div className="col-lg-4 text-center">
                            ...
                            <Typography sx={{ fontSize: '13px' }}>53 ngõ 514 Trần Cung, Cổ Nhuế 1, Bắc Từ Liêm, Thành phố Hà Nội</Typography>
                            <div>Giá <b className="text-danger">3.000.000 đ</b></div>
                            <div className="row" style={{ textAlign: 'left' }}>
                                <div className="col-6">
                                    <Typography sx={{ fontSize: '13px' }}>
                                        ...
                                        </svg> Chuyên mục: Chung cư mini</Typography>
                                    <Typography sx={{ fontSize: '13px' }}>
                                        ...
                                        </svg> Tình trạng: Chung cư mini</Typography>
                                    <Typography sx={{ fontSize: '13px' }}>
                                ...
                                <div className="col-6">
                                    <Typography sx={{ fontSize: '13px' }}>
                                        ...
                                        </svg> Ngày đăng: 20/10/2024</Typography>
                                    <Typography sx={{ fontSize: '13px' }}>
                                        ...
                                        </svg> Kiểm duyệt: <b className="text-warning">chờ phê duyệt</b> </Typography>
                                    <Typography sx={{ fontSize: '13px' }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                            <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5" />
                                        </svg> Số lượng người ở: 3</Typography>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 text-center mt-2">
                            <img style={{ borderRadius: '50%', height: '100px', width: '100px', objectFit: 'cover' }} src="https://thanhnien.mediacdn.vn/Uploaded/ngocthanh/2016_03_23/9x01_YGEO.jpg" alt="" srcset="" />
