                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6 col-sm-6 col-xs-12 mt-2 hide-when-edit">
                            <div className="form-check form-switch">
                              ...
                              <p className="text-setting-invoice">
                                Khi thu tiền hóa đơn bạn muốn phân tách các phiếu thu chi rõ ràng như: Tiền
                                phòng/giường, tiền dịch vụ, giảm trừ, cộng thêm
                              </p>
                            </div>
                          </div>
                          <hr className="my-2" />
                          ...
                          <div className="container tab-pane">
                            <div className="header-item">
                              <h4 className="title-item">
                                Cài đặt ngân hàng
                                <i style={{ fontSize: '14px', fontWeight: 'normal' }}>
                                  Dùng để hiển thị trên hóa đơn, mã xóa mã QR giúp khách thuê thanh toán chuyển khoản
                                  cho bạn dễ dàng hơn
                                  <br />
                                </i>
                              </h4>
                        ...
                        <div className="row">
                          <div className="col-md-6 col-sm-6 col-xs-12 mt-2 hide-when-edit">
                            <div className="form-check form-switch">
                              ...
                              <p className="text-setting-invoice">
                                Tự tạo tài khoản đăng nhập vào App khách thuê khi lập hợp đồng <br /> Tài khoản là số
                                điện thoại dùng cho lập hợp đồng <br /> Mật khẩu mặc định vui lòng nhập ở ô kê bên{' '}
                                <br /> *Lưu ý: Yêu cầu khách thuê cập nhật lại mật khẩu mới sau khi đăng nhập vào App
                              </p>
                            </div>
                          </div>
                          <div className="col-md-6 col-sm-6 col-xs-12 mt-2 hide-when-edit">
                          ...
                          <div className="container tab-pane">
                            <div className="header-item">
                              <h4 className="title-item">
                                Nội quy, giờ giấc, tiện ích cho thuê
                                <i style={{ fontSize: '14px', fontWeight: 'normal' }}>
                                  Thiết lập thời gian, nội quy và tiện ích. Các thông tin này sẽ được sẽ dụng để đăng
                                  tin trong khi tìm khách thuê.
                                  <br />
                                </i>
                              </h4>
                            </div>
