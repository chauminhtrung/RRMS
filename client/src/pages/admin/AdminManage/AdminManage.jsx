          ...
          <ul className="sidebar-nav">
            ...
            <li className="sidebar-item">
              <Link
                ...
                <i className="bi bi-kanban"></i> Quản Lý Chủ Trọ
              </Link>
              <ul id="manageLandlords" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-plus-circle"></i> Thêm Chủ Trọ
                  </Link>
                </li>
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-list-check fw-bold"></i> Danh Sách Chủ Trọ
                  </Link>
                </li>
              </ul>
            </li>
            <li className="sidebar-item">
              <Link
                ...
                <i className="bi bi-kanban"></i> Quản Lý Người Dùng
              </Link>
              <ul id="manageUsers" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                ...
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-list-check fw-bold"></i> Danh Sách Người Dùng
                  </Link>
                </li>
              </ul>
            </li>
            <li className="sidebar-item">
              <Link
                ...
                <i className="bi bi-kanban"></i> Quản Lý Đăng Tin
              </Link>
              <ul id="managePosts" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-plus-circle"></i> Thêm Đăng Tin
                  </Link>
                </li>
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-list-check fw-bold"></i> Danh Sách Đăng Tin
                  </Link>
                </li>
              </ul>
            </li>
            <li className="sidebar-item">
              <Link
                ...
                <i className="bi bi-kanban"></i> Quản Lý Báo Cáo
              </Link>
              <ul id="manageReports" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-plus-circle"></i> Thêm Báo Cáo
                  </Link>
                </li>
                <li className="sidebar-item">
                  <Link to="" className="sidebar-link">
                    <i className="bi bi-list-check fw-bold"></i> Danh Sách Báo Cáo
                  </Link>
                </li>
              </ul>
            </li>
      ...
      <div className="main">
        <nav className="navbar navbar-expand px-3 border-bottom d-flex justify-content-between">
          ...
          <div className="ms-auto d-flex">
            <div className="mx-2 point-item">
              <i className="bi bi-bell icon"></i> Thông báo
            </div>
            <div className="mx-2 point-item">
              <i className="bi bi-box-arrow-right icon"></i> Đăng xuất
            </div>
            <div className="mx-2 point-item">
              <i className="bi bi-person-lock icon"></i> Đổi Mật Khẩu
            </div>
            <div className="mx-2 point-item">
              <i className="bi bi-info-circle icon"></i> Trợ giúp
            </div>
          </div>
        </nav>
