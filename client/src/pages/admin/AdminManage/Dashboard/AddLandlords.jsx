    ...
    <Box sx={{backgroundColor: '#fff', borderRadius: '5px',marginTop:'27px'}}>
      <Grid container spacing={2} sx={{paddingLeft:'30px',paddingTop:'15px', marginBottom:'15px' }}> 
        ...
        <Grid item xs={12} sm={8} container>
          <Typography color="textSecondary" sx={{marginTop:'10px', marginRight:'20px',marginBottom:'-40px'}}>Tên người dùng: <span style={{color:'black'}}>Admin</span></Typography>    
          ...
          <Grid container spacing={2} wrap="nowrap" sx={{ marginTop: '10px', marginBottom: '10px', marginRight:'15px' }}>  
