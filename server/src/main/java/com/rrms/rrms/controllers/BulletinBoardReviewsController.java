...
public class BulletinBoardReviewsController {
    ...
    @PostMapping
    public ApiResponse<BulletinBoardReviewsResponse> createBulletinBoardReviews(@RequestBody BulletinBoardReviewsRequest request) {
    ...
    @GetMapping("")
    public ApiResponse<BulletinBoardReviewsResponse> getBulletinBoardReviewsByBulletinBoardIdAndUsername(@RequestParam("bulletinBoardId") UUID bulletinBoardId, @RequestParam("username") String username) {
        BulletinBoardReviewsResponse response = bulletinBoardReviewsService.getBulletinBoardReviewsByBulletinBoardIdAndUsername(bulletinBoardId, username);
        return ApiResponse.<BulletinBoardReviewsResponse>builder()
