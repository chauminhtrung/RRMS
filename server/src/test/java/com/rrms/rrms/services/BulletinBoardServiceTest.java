...
public class BulletinBoardServiceTest {
        ...
        void testUpdateBulletinBoard_Success() {
                ...
                RentalAmenities rentalAmenities = RentalAmenities.builder().name("Wi-Fi").build();
                ...
                BulletinBoardRequest bulletinBoardRequest = BulletinBoardRequest.builder()
                                ...
                                .bulletinBoardRules(Collections.singletonList(new BulletinBoardRule()))
                                .bulletinBoards_RentalAm(
                                                Collections.singletonList(bulletinBoards_RentalAm)) // Set
                                                                                                    // bulletinBoards_RentalAm
                                                                                                    // đã khởi tạo
                                .build();
                ...
                // Gọi phương thức cần kiểm tra
                BulletinBoardResponse result = bulletinBoardService.updateBulletinBoard(bulletinBoardId,
        ...
        void testUpdateBulletinBoard_BulletinBoardNotFound() {
                ...
                BulletinBoardRequest bulletinBoardRequest = BulletinBoardRequest.builder().title("Updated Title")
                                .build();
