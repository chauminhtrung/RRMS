...
public class AuthenControllerTest {
    ...
    // .andExpect(MockMvcResultMatchers.content().string("Không xác thực được tài
    // khoản Google"));
    // }
    //
    // @Test
    ...
    //
    // // Act & Assert
    // mockMvc.perform(MockMvcRequestBuilders.get("/authen/success").requestAttr("oauth2User",
    // oauthUser))
    // .andExpect(MockMvcResultMatchers.status().isBadRequest())
    // .andExpect(MockMvcResultMatchers.content().string("Không lấy được thông tin
    // email hoặc tên"));
    // }
    //
    // @Test
    ...
    // when(accountService.findByPhone("0123456789")).thenReturn(Optional.of(new
    // Account()));
    //
    // // Act & Assert
    ...
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Đăng nhập thành
    // công."))
    ...
    // when(accountService.findByPhone("0123456789")).thenReturn(Optional.of(new
    // Account()));
    // when(authorityService.loginResponse(loginRequest)).thenThrow(new
    ...
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Sai mật
    // khẩu"));
    // }
    ...
    // .andExpect(MockMvcResultMatchers.status().isOk())
    // .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(true))
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Đăng xuất thành
    // công."));
    // }
    //
    // @Test
    ...
    // doThrow(new ParseException("Invalid token",
    // 0)).when(authorityService).logout(logoutRequest);
    //
    // // Act & Assert
    // mockMvc.perform(MockMvcRequestBuilders.post("/authen/logout")
    // .contentType(MediaType.APPLICATION_JSON)
    ...
    // .andExpect(MockMvcResultMatchers.status().isUnauthorized())
    // .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(false))
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Token không hợp
    // lệ: Invalid
    // token"));
    // }
    ...
    // .andExpect(MockMvcResultMatchers.status().isOk())
    // .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(true))
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Đăng ký thành
    // công"))
    ...
    // .andExpect(MockMvcResultMatchers.status().isBadRequest())
    // .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(false))
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Tài khoản đã
    // tồn tại"));
    // }
    //
    // @Test
    // void register_withUnexpectedError_returnsInternalServerError() throws
    // Exception {
    // // Arrange
    // RegisterRequest registerRequest = RegisterRequest.builder()
    // .username("testuser")
    ...
    // .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(false))
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Đã xảy ra lỗi
    ...
    // // Arrange
    // IntrospecTokenRequest introspecTokenRequest = new
    // IntrospecTokenRequest("valid-token");
    // IntrospecTokenResponse introspecTokenResponse =
    // IntrospecTokenResponse.builder()
    // .valid(true)
    ...
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Token is
    // valid"))
    ...
    // .andExpect(MockMvcResultMatchers.status().isOk())
    // .andExpect(MockMvcResultMatchers.jsonPath("$.status").value(true))
    // .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Làm mới token
    // thành công."))
