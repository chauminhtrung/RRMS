...
import org.springframework.boot.test.mock.mockito.MockBean;  // <-- Use this import
...
public class MotelDeviceControllerTest {
    ...
    public void testGetMotelDevices_Success() throws Exception {
        ...
        MotelDeviceResponse device1 = new MotelDeviceResponse(
                UUID.randomUUID(), new MotelResponse(UUID.randomUUID(), "Motel A"), "Device 1",
                "icon1.png", 100.0, 50.0, 10, 5, 2, "Supplier 1", "unit1");

        MotelDeviceResponse device2 = new MotelDeviceResponse(
                UUID.randomUUID(), new MotelResponse(UUID.randomUUID(), "Motel B"), "Device 2",
                "icon2.png", 150.0, 70.0, 20, 10, 5, "Supplier 2", "unit2");
        ...
        ResultActions result = mockMvc.perform(get("/moteldevices/{motelId}", motelDeviceId)
    ...
    public void testDeleteMotelDevice_Success() throws Exception {
        ...
        ResultActions result = mockMvc.perform(delete("/moteldevices/{motelDeviceId}", motelDeviceId)
                .contentType("application/json"));
    ...
    public void testDeleteMotelDevice_Failure() throws Exception {
        ...
        UUID motelDeviceId = UUID.randomUUID();
        doThrow(new RuntimeException("Deletion failed")).when(motelDeviceService).deleteMotelDevice(motelDeviceId);
    ...
    public void testInsertMotelDevice_Success() throws Exception {
        ...
        when(motelDeviceService.insertMotelDevice(any(MotelDeviceRequest.class))).thenReturn(mockResponse);
    ...
    public void testInsertMotelDevice_Failure() throws Exception {
        ...
        when(motelDeviceService.insertMotelDevice(any(MotelDeviceRequest.class))).thenReturn(null);
